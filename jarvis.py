...
def TaskExe():
    ...
    #function for music
    def Music():
        Speak("tell methe name of the song!")
    ...
    #function for playing song in spotify
    def Task_Gui(self):
        ...
        if 'close this tab' in query:
            ...
            while True:
                ...
                if now == time:
                    ...
                    playsound.playsound(r"C:\Users\vinut\OneDrive\Documents\my project\Be Notorious BGM - Bheeshma Parvam ! Malayalam.mp3")
                    Speak("Alarm Closed")
